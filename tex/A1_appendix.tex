...
\begin{enumerate}
    ...
    \item \textbf{Stalwart}: \textit{Passive Ability}. Critical Hits against you only have a \texttimes 1.5 damage multiplier\footnote{Criticals boosted by Opportunist have a \texttimes 2.5 multiplier.}. You will only ever be Knockbacked by one tile instead of two.
